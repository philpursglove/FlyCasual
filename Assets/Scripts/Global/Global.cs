...
public class Global : MonoBehaviour
{
    ...
    public static string CurrentVersion = "v2.5.20260426.03";
    public static int CurrentVersionInt = 102508003;  // literal(10) XwingVersion(25) MajorUpdate#(increments) MinorUpdate#(increments)
    public static int LatestVersionInt = 0;

    // Used for json exports, update when vendor version changes
    public static string CurrentXWAVersion = "50P-2.0";
