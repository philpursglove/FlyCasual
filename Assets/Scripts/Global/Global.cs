...
public class Global : MonoBehaviour {
    ...
    public static string CurrentVersion = "v2.5.20251209.04";
    public static int CurrentVersionInt = 102507004;  // literal(10) XwingVersion(25) MajorUpdate#(increments) MinorUpdate#(increments)
