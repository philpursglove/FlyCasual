...
namespace SquadBuilderNS
{
    public class SquadBuilderUpgradesView
    {
        public void ShowAvailableUpgrades(UpgradeSlot slot)
        {
            ...
            if (slot.Type != UpgradeType.Omni)
            {
                filteredUpgrades = filteredUpgrades.Where(n =>
                     ...
                     && Content.XWingFormats.IsLegalForFormat(n.Instance, Options.ListFormat)
        ...
        private void ShowAvailableUpgrade(UpgradeRecord upgrade)
        {
            ...
            GenericUpgrade newUpgrade = (GenericUpgrade)System.Activator.CreateInstance(Type.GetType(upgrade.UpgradeTypeName));
