...
public class DeviceObjectInfoPanel : MonoBehaviour
{
    ...
    GenericObstacle parentObstacle;

    public void setParentObstacle(GenericObstacle parentObstacle)
    {
    ...
    private void Update()
    {
        ...
        {
            if (parentObstacle is ElectroChaffCloud && (parentObstacle as ElectroChaffCloud).IsFused)
            {
                ElectroChaffCloud chaffCloud = (ElectroChaffCloud)parentObstacle;
                ...
                numbers.text = $"T-{chaffCloud.Fuses}";
                LookAtCamera();
            }
            else
            {
