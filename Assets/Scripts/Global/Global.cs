...
public class Global : MonoBehaviour
{
    ...
    public static string CurrentVersion = "v2.5.20260426.02";
    public static int CurrentVersionInt = 102508002;  // literal(10) XwingVersion(25) MajorUpdate#(increments) MinorUpdate#(increments)
