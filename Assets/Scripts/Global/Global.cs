...
public class Global : MonoBehaviour {
    ...
    public static string CurrentVersion = "v2.5.20251026.01";
    public static int CurrentVersionInt = 102506001;  // literal(10) XwingVersion(25) MajorUpdate#(increments) MinorUpdate#(increments)
