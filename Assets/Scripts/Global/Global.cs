...
public class Global : MonoBehaviour {
    ...
    public static string CurrentVersion = "v2.5.20251026.02";
    public static int CurrentVersionInt = 102506002;  // literal(10) XwingVersion(25) MajorUpdate#(increments) MinorUpdate#(increments)
