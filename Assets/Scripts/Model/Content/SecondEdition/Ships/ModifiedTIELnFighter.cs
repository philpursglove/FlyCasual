...
namespace Ship.SecondEdition.ModifiedTIELnFighter
{
    public class ModifiedTIELnFighter : GenericShip
    {
        public ModifiedTIELnFighter() : base()
        {
            ...
            ShipAbilities.Add(new Abilities.SecondEdition.NotchedStabilizersAbility());
...
{
    public class NotchedStabilizersAbility : GenericAbility
    {
