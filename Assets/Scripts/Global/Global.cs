...
public class Global : MonoBehaviour {
    ...
    public static string CurrentVersion = "v2.5.20250623.03";
    public static int CurrentVersionInt = 102505003;  // literal(10) XwingVersion(25) MajorUpdate#(increments) MinorUpdate#(increments)
